...
public class ServerWorkerRunnable implements Runnable{
    ...
    private MainActivity.ChatListMessageHandler chatListMessageHandler;
    ...
    public void run(){
        try {
            ...
            while(true){
                ...
                if (chatListMessageHandler == null){
                    chatListMessageHandler = MainActivity.chatListMessageHandler;
                }
                if (chatMessageHandler != null)
                    chatMessageHandler.sendEmptyMessage(ChatActivity.NEW_MESSAGE);
                if (chatListMessageHandler != null)
                    chatListMessageHandler.sendEmptyMessage(ChatActivity.NEW_MESSAGE);
